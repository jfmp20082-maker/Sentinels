...
vulneración como:
  1. Acceso a datos sin iniciar sesion
  2. Token de sesion falso(manipulado)
  3. Inyeccion SQL en el login
  4. Backdoor de 2AF de demo(/api/demo/*`totp`*)
  5. Backdoor de codgio de acceso(/api/dev/last-code)
  6. Fuerza bruta de contraseña
  7. Robo de sesion via CORS malicioso
  8. Acceso directo a archivos con secretos 
  9. Recorrido de direcciones(path transversal)

Se especifica mas en el apartado de seguridad en el [Manual Tecnico](/docs/ManualTecnico.md)
...
## Las cuatro piezas `Cambio proximo`
...
50 pruebas sobre lo que tiene lógica de verdad:
